...
const COMPANIES = [
  ...
  { name: 'CoreWeave',        color: '#8b5cf6', keywords: ['coreweave'],                                              secCik: '2031876' },
  { name: 'Crusoe Energy',    color: '#f43f5e', keywords: ['crusoe'] },
  { name: 'Nebius Group',     color: '#14b8a6', keywords: ['nebius'],                                                 secCik: '1731348' },
  { name: 'Lambda',           color: '#a3e635', keywords: ['lambda labs', 'lambda gpu', 'lambda cloud'] },
  { name: 'Nscale',           color: '#fb923c', keywords: ['nscale'] },
